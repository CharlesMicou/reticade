...
for i = 1:kiek_frames         
    ...
    pos_man_reward(i) = fread(fileID,1,'*double','ieee-be');
    pos_feeder_opening(i) = fread(fileID,1,'*double','ieee-be');
    pos_random_reward(i) = fread(fileID,1,'*double','ieee-be');
    pos_velocity(i) = fread(fileID,1,'*double','ieee-be');
    pos_hardcoded_998(i) = fread(fileID,1,'*double','ieee-be');
end
